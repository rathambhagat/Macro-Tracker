...
Core philosophy: no food names, no ingredient lists.
The user logs raw macro numbers (Kcal / Protein / Carbs / Fats) and hits "LOG MACROS".
...
class MacroTrackerApp(MDApp):
    def build(self):
        ...
        # Explicitly pass the writable Android directory to the Database
        db_path = os.path.join(self.user_data_dir, "macro_tracker.db")
